...
const COLS = 'id,name,bibNumber,raceName,category,finishTime,netTime,genderRank,overallRank,date,inspirationalQuote,badgeImageUrl,logoUrl,themeImageUrl,runnerImageUrl,signatureUrl';

function vals(f) {
  return [f.id,f.name,f.bibNumber??null,f.raceName,f.category,f.finishTime,f.netTime??null,f.genderRank??null,f.overallRank??null,f.date,f.inspirationalQuote??null,f.badgeImageUrl??null,f.logoUrl??null,f.themeImageUrl??null,f.runnerImageUrl??null,f.signatureUrl??null];
}
